...
<head>
   ...
   <link href="/iimmm/css/normalize.css" type="text/css" rel="stylesheet"/>
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.1.4/semantic.min.css">
   <link href="/iimmm/css/style.css" type="text/css" rel="stylesheet"/>
...
<body class="ui grid">
   <header class="row sixteen wide column">
      <h1 class="ui header">International Institute of Multiscale Materials Modeling</h1>
       ...
       <nav id='m_nav' class="ui inverted menu">
          ...
          <div id='m_btn' class="ui item labeled icon button right aligned">
   ...
   <nav id='m_menu' class="ui left vertical inverted labeled icon sidebar menu">
      <a class="item" id="back">
        <i class="right arrow icon"></i> Back
      </a>
